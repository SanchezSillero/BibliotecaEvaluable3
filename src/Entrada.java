...
public class Entrada {
    public static void main(String[] args) {
        ...
        BibliotecaEspecializada bibliotecaEspEnsayos = new BibliotecaEspecializada("Biblioteca Universidad Politécnica", "Patricia Sillero", Tipo.ensayo);//solo aceptara ENSAYOS
 ...
 /*      //creamos algunos libros (no están en ningun catalogo)
        ...
        LibroPoliciaca libroPoliciaca1 = new LibroPoliciaca(4, "Los crímenes de la calle Morgue", "Edgar Allan Poe", 66, Tipo.policiaca , Trama.intriga, listaPersonajesLibroPoliciaca1);
        Ensayo ensayo2 = new Ensayo(5, "El arte de la guerra", "Sun Tzu", 112, Tipo.ensayo, "Estrategia");
        ...
        bibliotecaEspTerror.agregarLibroListaCompartida(libroComedia1);//vemos que aqui no hay problemas por agregar un libro que no es de su tipo
